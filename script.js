...
// and the total of the expenses, then shows the difference in the app
...
//Write a function that adds expenses to the expense array based on user input, then update the expense list
...
//Write a function that will loop through the expenses and re-caculate the total, then display in the app
function updateExpenseTotal () {
    console.log('updateExpenseTotal fired!');
    // Reset total expenses
    expenseTotal = 0;
    // Loop through expenses and re-caculate 
